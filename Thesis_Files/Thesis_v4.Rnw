...
\textcolor{red}{dean - [regarding the following paragraph] you need to finish the section on discriminating scientific hypotheses. As written, it just stops. }\\
\textcolor{blue}{The carriage return and new paragraph were inadvertent.}\\

\textcolor{red}{You also need a transition ?a paragraph? to Bayesian prediciton vs. plug-in estimators.}\\
\textcolor{blue}{See additional sentences added to the paragraph below. Does that suffice?}\\
