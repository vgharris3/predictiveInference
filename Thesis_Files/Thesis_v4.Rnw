...
res = hist(pred_sample, prob = TRUE, breaks = breaks,main = "Histogram of Sample with Probability Mass Overlay",ylim = c(0,max(f_t)*1.5),xlim = c(0,M),xlab = xlabel,ylab = "Count")
...
# par(mfrow = c(2,1))
#
# hist(pred_sample, prob = TRUE, main = "Histogram of Sample with Density Curve Overlay",ylim = c(0,max(f_x)*1.5),xlim = c(0,m))
# lines(0:m,f_x)
#
...
hist(pred_sample,prob = TRUE,main = "Histogram of Sample with Density Curve Overlay", ylim = c(0,max(f_y)*1.1),xlab = xlabel,ylab = "Count")
lines(1:1000,f_y)
...
#Predictive sample
S = 100000 #Predictive sample size
...
res = hist(pred_sample,prob = TRUE, main = "Histogram of Sample with Probability Mass Overlay",xlim = c(0,length(F_y)),ylim = c(0,max(f_Rand)*1.1),breaks = breaks, xlab = xlabel, ylab = "Count")
