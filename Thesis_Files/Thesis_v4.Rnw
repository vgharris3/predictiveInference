...
\textcolor{blue}{Anything else needed here?}
...
}\textcolor{blue}{better?}

\begin{flalign*}
  \texttt{S} &= S \text{, the number of MCMC realizations to be generated (the desired random sample size)}\\
