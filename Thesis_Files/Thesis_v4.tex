...
\begin{center}
  ...
  \multicolumn{1}{c}{\textbf{Prediction Method}} & \multicolumn{1}{c}{$\textbf{(}\boldsymbol\alpha,\boldsymbol\beta\textbf{)}$}  & \multicolumn{1}{c}{\textbf{Prior Mean }$\textbf{E(}\boldsymbol\theta\textbf{)}$}  & \multicolumn{1}{c}{\textbf{Prediction Mean}} & \multicolumn{1}{c}{\textbf{SD}}\\
        \midrule
        Beta-Binomial & (2,8) & 0.2 & 30.73 & 11.27 \\
        \midrule
        Beta-Binomial & (22,78) & 0.22 & 23.91 & 5.96\\
        \midrule
        Beta-Binomial & (224,776) & 0.224 & 22.51 & 4.57 \\
        \midrule
...
\section{Appendix}
  ...
  \subsection{Normal-Inverse Gamma R Functions}
    \subsubsection{\texttt{dpredNormIG1()}}
      \begin{verbatim}
        dpredNormIG1 = function(ypred,y,mu0=0,k0=1,sig20=1,nu0=1,S = 100000,
          Jeffreys=FALSE){
      ...
      \end{verbatim}
    \subsubsection{\texttt{ppredNormIG1()}}
      \begin{verbatim}
        ppredNormIG1 = function(ypred,y,mu0=0,k0=1,sig20=1,nu0=1,S = 100000,
          Jeffreys=FALSE){
      ...
      \end{verbatim}
    \subsubsection{\texttt{rpredNormIG1()}}
      \begin{verbatim}
      ...
      \end{verbatim}
    \subsubsection{\texttt{rpredNormIG2()}}
      \begin{verbatim}
      ...
      \end{verbatim}
    \subsubsection{\texttt{rpredNormIGk()}}
              \begin{verbatim}
  ...
  \subsection{Normal Regression R Function}
    \subsubsection{\texttt{rpredNormIGkReg()}}
      \begin{verbatim}
        rpredNormReg = function(S=1,Xpred,X,y,beta0,Sigma0,nu0=1,s20=1,
          gprior = TRUE){
