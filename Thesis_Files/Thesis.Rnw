...
The standard format R function rpredNormReg() approximates the joint posterior density $p(\sigma^2,\beta|\mathbf{y,X})$ by means of Monte Carlo sampling, as follows.
