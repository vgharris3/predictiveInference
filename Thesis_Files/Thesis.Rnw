...
#Predictive density
f_1000 = dpredBB(1:M,N,t,M,a,b)
plot(1:M,f_1000,type = "l", col = "blue", lwd = 2, main = "Beta-Binomial Predictive Density")

#Cumulative predictive probability
F_1000 = ppredBB(1:M,N,t,M,a,b)
plot(1:M,F_1000,type = "l", col = "red", lwd = 2, main = "Beta-Binomial Cumulative Predictive Probability")

#Random sample
f_x = dpredBB(1:M,N,t,M,a,b)
