...
plot(x,xd,type="l",col="blue",lwd=2,main=plotTitle_dp,xlab="y",ylab = "dpredNormIG(y)")
...
plot(x,xp,type="l",col="blue",lwd=2,main=plotTitle_pp,xlab="y",ylab = "ppredNormIG(y)")
...
\noindent from which the full conditional distributions follow:\\
      ...
      Using the full-conditional distributions given above, we can construct a Gibbs sampler to approximate the posterior distribution $p\left(\mu,\delta,\sigma^2|\mathbf{y}_1,\mathbf{y}_2\right)$.
