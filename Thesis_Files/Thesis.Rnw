...
set.seed(1234)
random_sample = rpredNormIG(S,y,mu0,k0,sig20,nu0)
H = hist(random_sample,probability = TRUE)



x = sort(runif(10,min = min(random_sample),max = max(random_sample)))
#tic()
...
#making this change just to test git push
