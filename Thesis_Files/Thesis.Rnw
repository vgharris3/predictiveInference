...
#obs = rep(100,10)
ytilde = 100
alpha = 11  #how to pick alpha and beta?
beta = 3
par(mfrow=c(3,1))

#Predictive density
f_x = dpredPG(obs, ytilde, alpha, beta)
plot(1:length(f_x),f_x,type = "l", col = "blue", lwd = 2, main = "Poisson-Gamma Predictive Density")

#Cumulative predictive probability
F_x = ppredPG(obs, ytilde, alpha, beta)
plot(1:length(F_x),F_x,type = "l", col = "red", lwd = 2, main = "Poisson-Gamma Cumulative Predictive Probability")
