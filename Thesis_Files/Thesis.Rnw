...
\section{Introduction:  Predictive Inference}
  ...
  \subsection{Difference between parametric inference and predictive inference}
    ...
    \subsubsection{When is parametric inference more useful?}
      ...
      When the goal is to extract a maximum amount of information from a data set and summarise it in a handful of quantities, inferences about parameters can be useful.  Parametric inference can also be helpful in determining whether a particular problem is worth continued attention.
