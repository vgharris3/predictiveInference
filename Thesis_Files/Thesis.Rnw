...
matplot(densities_x,densities_y,type="l",lty=1,col=1:length(mu0),xlim = c(1,3))
points(densities_x[,5],densities_y[,5],pch = 20,col=5)
lines(density(random_sample_J),lty=1,lwd=2,col="red")
legend("topright",legend = c(mu0,"Jeffreys"),lty=c(1,1,1,1,NA,1,1,1,1,1,1,1),lwd=c(rep(1,11),2),pch=c(NA,NA,NA,NA,20,NA,NA,NA,NA,NA,NA,NA),col=c(1:length(mu0),"red"))
