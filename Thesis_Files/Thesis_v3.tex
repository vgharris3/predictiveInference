...
\begin{center}
  ...
  \multicolumn{1}{c}{\textbf{Prediction Method}} & \multicolumn{1}{c}{$\textbf{(}\boldsymbol\alpha,\boldsymbol\beta\textbf{)}$}  & \multicolumn{1}{c}{$\textbf{E(}\boldsymbol\theta\textbf{)}$}  & \multicolumn{1}{c}{\textbf{mean}} & \multicolumn{1}{c}{\textbf{SD}}\\
        \midrule
        Beta-Binomial & (2,8) & 0.2 & 30.37 & 11.03 \\
        \midrule
        Beta-Binomial & (22,78) & 0.22 & 23.5 & 5.94\\
        \midrule
        Beta-Binomial & (224,776) & 0.224 & 22.6 & 4.26 \\
        \midrule
...
\includegraphics{Thesis_v3-016}

\includegraphics{Thesis_v3-017}

\clearpage


\includegraphics{Thesis_v3-018}

\clearpage

Comparing predictions using semi-conjugate prior vs. Zellner's g-prior:

\includegraphics{Thesis_v3-019}
...
\includegraphics{Thesis_v3-022}

\includegraphics{Thesis_v3-023}

\includegraphics{Thesis_v3-024}

\includegraphics{Thesis_v3-025}

\includegraphics{Thesis_v3-026}
