...
<<fig=TRUE, echo=FALSE>>=
#source('G:/My Drive/Education/STATISTICS/UA_STATS/MASTERS/THESIS/BILLHEIMER/Thesis/Functions/BetBin.R')
...
hist(random_sample,prob = T, main = "Histogram of Sample with Density Curve Overlay")
lines(1:1000,f_x)
@
...
<<fig=TRUE, echo=FALSE>>=
#source('G:/My Drive/Education/STATISTICS/UA_STATS/MASTERS/THESIS/BILLHEIMER/Thesis/Functions/ExpGam.R')
